  ...
  return (
    <div className="">
      {modelUser.user && modelUser.isModelOpen && (
        ...
        >
          <div className="border-2 absolute shadow-md top-1/2 left-1/2 overflow-y-scroll transform -translate-x-1/2 -translate-y-1/2 w-11/12 md:w-2/3 lg:w-1/4 md:h-2/3 lg:h-3/4 h-3/4 flex-wrap bg-white rounded-2xl">
            <div className="bg-violet-400 h-2/3 md:h-1/2 w-full rounded-br-[30%] rounded-t-2xl">
            ...
            <div className="flex flex-col gap-3 py-2 items-center">
              ...
              <hr className="w-3/4" />
              <div className="w-full md:flex justify-center gap-7 pt-1 text-center">
                <div>
                  <h1 className="font-semibold opacity-60 font-mono">Playgrounds</h1>
                  <h2 className="font-black opacity-70 font-serif text-lg">5</h2>
                </div>
                <div>
                  <h1 className="font-semibold opacity-60 font-mono pt-2 md:pt-0">Templates</h1>
                  <h2 className="font-black opacity-70 font-serif text-lg">9</h2>
                </div>
              </div>
              <div className="w-full md:flex justify-center gap-7 p pt-1 text-center">
                <div>
                ...
                <div>
                  <h1 className="font-semibold opacity-60 font-mono pt-2 md:pt-0">Total cost</h1>
